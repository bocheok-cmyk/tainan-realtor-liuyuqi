...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-1 items-center justify-center px-6 py-24">
      <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-card border border-border bg-background p-8">
        <h1 className="text-2xl font-bold">網站後台</h1>
        <p className="mt-1 text-sm text-text/70">登入管理</p>
